...
func executeSET(tokens []string, cache *Cache) (Response, error) {
...
func executeGET(tokens []string, cache *Cache) (Response, error) {
	if len(tokens) != 2 {
...
func executeAPPEND(tokens []string, cache *Cache) (Response, error) {
	if len(tokens) != 3 {
...
func executeSTRLEN(tokens []string, cache *Cache) (Response, error) {
	if len(tokens) != 2 {
...
func executeGETSET(tokens []string, cache *Cache) (Response, error) {
	if len(tokens) != 3 {
...
func executeINCR(tokens []string, cache *Cache) (Response, error) {
	if len(tokens) != 2 {
...
func executeDECR(tokens []string, cache *Cache) (Response, error) {
	if len(tokens) != 2 {
...
func executeINCRBY(tokens []string, cache *Cache) (Response, error) {
	if len(tokens) != 3 {
...
func executeDECRBY(tokens []string, cache *Cache) (Response, error) {
	if len(tokens) != 3 {
...
func executeMSET(tokens []string, cache *Cache) (Response, error) {
	if len(tokens) < 3 {
...
func executeMGET(tokens []string, cache *Cache) (Response, error) {
	if len(tokens) < 2 {
